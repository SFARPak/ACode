...
### 3. Unisciti alla community ACode

- **Principale:** Unisciti al nostro [Discord](https://discord.gg/roocode) e invia un DM a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** I collaboratori esperti possono partecipare direttamente tramite [GitHub Projects](https://github.com/orgs/ACodeInc/projects/1).
...
- **Verificare le issue esistenti:** Cerca su [GitHub Issues](https://github.com/ACodeInc/Roo-Code/issues).
...
- Controlla il [Progetto GitHub](https://github.com/orgs/ACodeInc/projects/1) per "Good First Issues" non assegnate.
- Per la documentazione, visita [ACode Docs](https://github.com/ACodeInc/Roo-Code-Docs).

### Segnalare bug

- Controlla prima i report esistenti.
- Crea nuovi report di bug usando il [template "Bug Report"](https://github.com/ACodeInc/Roo-Code/issues/new/choose).
- **Problemi di sicurezza:** Segnala privatamente tramite [security advisories](https://github.com/ACodeInc/Roo-Code/security/advisories/new).
...
Inviando una pull request, accetti che i tuoi contributi siano concessi in licenza sotto la Licenza Apache 2.0, in linea con la licenza di ACode.
