...
### 3. ACode Topluluğuna Katıl

- **Ana yöntem:** [Discord](https://discord.gg/roocode)'umuza katıl ve **Hannes Rudolph (`hrudolph`)**'a DM gönder.
- **Alternatif:** Deneyimli katkı sağlayanlar [GitHub Projects](https://github.com/orgs/ACodeInc/projects/1) üzerinden doğrudan katılabilir.
...
- **Mevcut issue'ları kontrol et:** [GitHub Issues](https://github.com/ACodeInc/Roo-Code/issues)'da ara.
...
- [GitHub Projesi](https://github.com/orgs/ACodeInc/projects/1)'nde atanmamış "Good First Issues" bak.
- Dokümantasyon için [ACode Docs](https://github.com/ACodeInc/Roo-Code-Docs)'u ziyaret et.

### Hata veya Sorun Bildirme

- Önce mevcut raporları kontrol et.
- ["Bug Report" şablonu](https://github.com/ACodeInc/Roo-Code/issues/new/choose) kullanarak yeni hata raporları oluştur.
- **Güvenlik açıkları:** [security advisories](https://github.com/ACodeInc/Roo-Code/security/advisories/new) aracılığıyla özel olarak bildir.
...
Pull request göndererek, katkılarının ACode'un lisanslamasıyla tutarlı olarak Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursun.
