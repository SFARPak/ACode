		...
		<>
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					...
					<p className="lead">
						This Privacy Policy explains how ACode, Inc. (&quot;ACode,&quot; &quot;we,&quot;
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the ACode extension <strong>without</strong> connecting to a Cloud account, your
							data is governed by the standalone{" "}
							<a
								href="https://github.com/ACodeInc/Roo-Code/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								ACode Extension Privacy Policy
							</a>
							.
						</p>
					</div>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or ACode (proxy mode;
										transit‑only) when you select ACode as the provider
									</td>
									<td className="border border-border px-4 py-2">
										ACode servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										ACode servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on ACode servers.
						</li>
						<li>
