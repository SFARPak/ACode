...
const faqs: FAQItem[] = [
	{
		question: "What exactly is ACode?",
		answer: (
			<>
				ACode is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does ACode differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				ACode is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: ACode is{" "}
	...
	{
		question: "Is ACode really free?",
		answer: (
			<>
				Yes! ACode is completely free and open-source. You&apos;ll only pay for the AI model usage if you use a
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because ACode is an extension in your local VS Code, your code never leaves your machine unless you
				connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can use
				tools like .rooignore to exclude sensitive files, and you can also run ACode with offline/local models
				for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does ACode support?",
		answer: (
			<>
				ACode is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer. It
				...
				connect any other model that follows ACode&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does ACode support my programming language?",
		answer: (
			<>
				Likely yes! ACode supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go, Rust,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. ACode uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about ACode for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. ACode was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because ACode is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can ACode run commands and tests automatically?",
		answer: (
			<>
				Yes! One of ACode&apos;s biggest strengths is its ability to execute commands—always optional and fully
	...
	},
	{
		...
		answer: (
			<>
				ACode shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask it
	...
	},
	{
		...
		answer: (
			<>
				Yes, please do! ACode is open-source on{" "}
				<a
					href="https://github.com/ACodeInc/Roo-Code"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@ACodeYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about ACode and how it can transform your development workflow.
						</p>
					</motion.div>
				</div>
