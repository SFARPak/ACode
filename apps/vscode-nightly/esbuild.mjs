...
import { getGitSha, copyPaths, copyLocales, copyWasms, generatePackageJson } from "@acode/build"
...
async function main() {
	...
	const buildOptions = {
		...
		platform: "node",
		define: {
			"process.env.PKG_NAME": '"acode-nightly"',
			...
			setup(build) {
				build.onEnd(() => {
					...
					const generatedPackageJson = generatePackageJson({
						packageJson,
						overrideJson,
						substitution: ["roo-cline", "acode-nightly"],
					})
