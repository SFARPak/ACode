...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the ACode settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause ACode to hang, particularly in orchestrator mode
...
- Simplify and streamline ACode's quick actions
- Allow ACode settings to be imported from the welcome screen (thanks @julionav)
...
- Focus ACode in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus ACode input field (thanks @axkirillov!)
...
- Allow processes to access the ACode API via a unix socket
...
- Add an activation command that other extensions can use to interface with ACode (thanks @gtaylor!)
...
- Internationalize ACode into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Expose task stack in `ACodeAPI` (thanks @franekp!)
...
- Add opt-in telemetry to help us improve ACode faster (thanks Cline!)
...
- Add support for a .rooignore to prevent ACode from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into ACode (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/ACodeInc/Roo-Code/issues/1173))
...
- Introducing ACode 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New ACode community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to ACode:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to ACode to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for ACode! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
Join us at https://www.reddit.com/r/ACode to share your custom modes and be part of our next chapter!
...
- This release adds chat modes! Now you can ask ACode questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new ACode Reddit! https://www.reddit.com/r/ACode
...
- Incorporate Premshay's [PR](https://github.com/ACodeInc/Roo-Code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/ACodeInc/Roo-Code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/ACodeInc/Roo-Code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/ACodeInc/Roo-Code/pull/42) to add support for OpenRouter compression
