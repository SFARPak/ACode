...
export type ACodeSettings = GlobalSettings & ProviderSettings
...
export type GlobalState = Omit<ACodeSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<ACodeSettings>) => !isSecretStateKey(key),
) as Keys<GlobalState>[]
...
export const EVALS_SETTINGS: ACodeSettings = {
