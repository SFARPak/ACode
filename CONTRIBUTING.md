...
ACode is a community-driven project, and we deeply value every contribution. To streamline collaboration, we operate on an [Issue-First](#issue-first-approach) basis, meaning all [Pull Requests (PRs)](#submitting-a-pull-request) must first be linked to a GitHub Issue. Please review this guide carefully.
...
### 3. Join the ACode Community

- **Primary:** Join our [Discord](https://discord.gg/roocode) and DM **Hannes Rudolph (`hrudolph`)**.
- **Alternative:** Experienced contributors can engage directly via [GitHub Projects](https://github.com/orgs/ACodeInc/projects/1).
...
- **Check existing issues**: Search [GitHub Issues](https://github.com/ACodeInc/Roo-Code/issues).
...
- Check the [GitHub Project](https://github.com/orgs/ACodeInc/projects/1) for unassigned "Good First Issues."
- For docs, visit [ACode Docs](https://github.com/ACodeInc/Roo-Code-Docs).

### Reporting Bugs

- Check for existing reports first.
- Create new bugs using the ["Bug Report" template](https://github.com/ACodeInc/Roo-Code/issues/new/choose).
- **Security issues**: Report privately via [security advisories](https://github.com/ACodeInc/Roo-Code/security/advisories/new).
...
By contributing, you agree your contributions will be licensed under the Apache 2.0 License, consistent with ACode's licensing.
