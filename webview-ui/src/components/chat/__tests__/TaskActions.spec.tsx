import type { HistoryItem } from "@acode/types"
	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to ACode Cloud to share tasks",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to ACode Cloud")).toBeInTheDocument()
