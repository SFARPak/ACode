...
import type { TelemetrySetting } from "@acode/types"
			...
			<Section>
				...
				<div>
					<Trans
						...
						components={{
							githubLink: <VSCodeLink href="https://github.com/ACodeInc/Roo-Code" />,
							redditLink: <VSCodeLink href="https://reddit.com/r/ACode" />,
