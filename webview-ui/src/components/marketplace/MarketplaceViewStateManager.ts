 ...
 *
 * This class manages the state for the marketplace view in the ACode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ACode extensions interface
...
import { MarketplaceItem } from "@acode/types"
